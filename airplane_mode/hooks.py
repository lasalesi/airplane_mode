...
app_description = "Certification App for Frappe Framework Certification"
...
add_to_apps_screen = [
 	{
 		"name": "airplane_mode",
 		"logo": "/assets/airplane_mode/img/turtle.png",
 		"title": "Airplane Mode",
 		"route": "/airplane_mode",
...
# after_build = "airplane_mode.build.after_build"
...
# awesomebar_search = ["airplane_mode.search.awesomebar_results"]
